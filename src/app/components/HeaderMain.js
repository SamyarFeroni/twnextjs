      ...
      <div className="grid grid-cols-5 gap-4 w-full max-w-6xl mb-10">
        ...
        >
          <div className="mb-14 text-right">
            <ShowImage alt={"Banimode Logo"} itemLinks={ImageLink.BanimodeLogo} widths={360} heights={60}/>
          </div>
          <div
          ...
          >
            <ShowImage alt={"Bazar Logo"} itemLinks={ImageLink.BazarLogo} widths={50} heights={60}/>
            <div className="text-white w-fit ml-2">دریافت اپلیکیشن از</div>
          </div>

          <div
            className="bg-gray-50 border border-black p-4 rounded-lg shadow-md mb-4 cursor-pointer relative flex justify-center" style={{ width: "240px", height: "52px" }}>
            <ShowImage alt={"sibapp Logo"} itemLinks={ImageLink.sibappLogo} widths={56} heights={60}/>
          ...
          >
            ...
            <ShowImage  alt={"DWN Logo"}  itemLinks={ImageLink.DWNLogo}  heights={24}  widths={24}/>
          </div>

          <div className="flex justify-between mt-4">
            <ShowImage alt="twitter"  itemLinks={ImageLink.twitter}  widths={20} heights={20}/>
            <ShowImage alt="aparat"  itemLinks={ImageLink.aparat}  widths={20} heights={20}/>
            <ShowImage alt="telegram"  itemLinks={ImageLink.telegram}  widths={20} heights={20}/>
            <ShowImage alt="instagram" itemLinks={ImageLink.instagram} widths={20} heights={20}/>
          </div>
        </div>
        ...
        <div className="flex flex-col text-right ml-2" dir="rtl">
          ...
          <div>
            <ShowImage alt={"Bani Mag"} itemLinks={ImageLink.BaniMag} heights={150} widths={150}
            />
          </div>
        </div>
